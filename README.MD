...
```ts
import { Client } from 'https://deno.land/x/gamebanana-api/mod.ts';
```
...
#### <a name="login"></a>Client.login(options: [`ClientConfig`](#clientconfig), format?: keyof [`FormatTypes`](#formattypes)): Promise&lt;string&gt;
